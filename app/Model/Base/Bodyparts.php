...
/**
 * Base class that represents a row from the 'bodyparts' table.
 *
 *
 *
 * @package    propel.generator..Base
 */
abstract class Bodyparts implements ActiveRecordInterface
{
    /**
     * TableMap class name
     */
    const TABLE_MAP = '\\Map\\BodypartsTableMap';
    ...
    /**
     * Initializes internal state of Base\Bodyparts object.
     */
    ...
    /**
     * Compares this with another <code>Bodyparts</code> instance.  If
     * <code>obj</code> is an instance of <code>Bodyparts</code>, delegates to
     * <code>equals(Bodyparts)</code>.  Otherwise, returns <code>false</code>.
     *
    ...
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[BodypartsTableMap::COL_ID] = true;
        }
    ...
    public function setCode($v)
    {
        ...
        if ($this->code !== $v) {
            $this->code = $v;
            $this->modifiedColumns[BodypartsTableMap::COL_CODE] = true;
        }
    ...
    public function setName($v)
    {
        ...
        if ($this->name !== $v) {
            $this->name = $v;
            $this->modifiedColumns[BodypartsTableMap::COL_NAME] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : BodypartsTableMap::translateFieldName('Id', TableMap::TYPE_PHPNAME, $indexType)];
            $this->id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : BodypartsTableMap::translateFieldName('Code', TableMap::TYPE_PHPNAME, $indexType)];
            $this->code = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : BodypartsTableMap::translateFieldName('Name', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            return $startcol + 3; // 3 = BodypartsTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException(sprintf('Error populating %s object', '\\Bodyparts'), 0, $e);
        }
    }
    ...
    public function reload($deep = false, ConnectionInterface $con = null)
    {
        ...
        $dataFetcher = ChildBodypartsQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
     ...
     * @return void
     * @throws PropelException
     * @see Bodyparts::setDeleted()
     * @see Bodyparts::isDeleted()
     */
    public function delete(ConnectionInterface $con = null)
    {
        ...
        $con->transaction(function () use ($con) {
            $deleteQuery = ChildBodypartsQuery::create()
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                BodypartsTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(BodypartsTableMap::COL_ID)) {
            $modifiedColumns[':p' . $index++]  = 'id';
        }
        if ($this->isColumnModified(BodypartsTableMap::COL_CODE)) {
            $modifiedColumns[':p' . $index++]  = 'code';
        }
        if ($this->isColumnModified(BodypartsTableMap::COL_NAME)) {
            $modifiedColumns[':p' . $index++]  = 'name';
        }

        $sql = sprintf(
            'INSERT INTO bodyparts (%s) VALUES (%s)',
    ...
    {
        $pos = BodypartsTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        if (isset($alreadyDumpedObjects['Bodyparts'][$this->hashCode()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['Bodyparts'][$this->hashCode()] = true;
        $keys = BodypartsTableMap::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getId(),
            $keys[1] => $this->getCode(),
            $keys[2] => $this->getName(),
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(BodypartsTableMap::COL_ID)) {
            $criteria->add(BodypartsTableMap::COL_ID, $this->id);
        }
        if ($this->isColumnModified(BodypartsTableMap::COL_CODE)) {
            $criteria->add(BodypartsTableMap::COL_CODE, $this->code);
        }
        if ($this->isColumnModified(BodypartsTableMap::COL_NAME)) {
            $criteria->add(BodypartsTableMap::COL_NAME, $this->name);
        }
    ...
    {
        $criteria = ChildBodypartsQuery::create();
        $criteria->add(BodypartsTableMap::COL_ID, $this->id);
     ...
     * objects.
     *
     * @param      object $copyObj An object of \Bodyparts (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \Bodyparts Clone of current object.
     * @throws PropelException
     */
     ...
     * If this ChildBodyparts is new, it will return
     ...
     * @param      ConnectionInterface $con Optional connection object
     * @return $this|ChildBodyparts The current object (for fluent API support)
     */
    ...
    {
        return (string) $this->exportTo(BodypartsTableMap::DEFAULT_STRING_FORMAT);
    }
