...
/**
 * Base class that represents a row from the 'frags' table.
 *
 *
 *
 * @package    propel.generator..Base
 */
abstract class Frags implements ActiveRecordInterface
{
    /**
     * TableMap class name
     */
    const TABLE_MAP = '\\Map\\FragsTableMap';
    ...
    /**
     * The value for the weapon_id field.
     *
     * @var        int
     */
    protected $weapon_id;
    ...
    /**
     * Initializes internal state of Base\Frags object.
     */
    ...
    /**
     * Compares this with another <code>Frags</code> instance.  If
     * <code>obj</code> is an instance of <code>Frags</code>, delegates to
     * <code>equals(Frags)</code>.  Otherwise, returns <code>false</code>.
     *
    ...
    /**
     * Get the [weapon_id] column value.
     *
     * @return int
     */
    ...
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[FragsTableMap::COL_ID] = true;
        }
    ...
    public function setFraggerId($v)
    {
        ...
        if ($this->fragger_id !== $v) {
            $this->fragger_id = $v;
            $this->modifiedColumns[FragsTableMap::COL_FRAGGER_ID] = true;
        }
    ...
    public function setFraggedId($v)
    {
        ...
        if ($this->fragged_id !== $v) {
            $this->fragged_id = $v;
            $this->modifiedColumns[FragsTableMap::COL_FRAGGED_ID] = true;
        }
    ...
    /**
     * Set the value of [weapon_id] column.
     *
     * @param int $v New value
     * @return $this|\Frags The current object (for fluent API support)
     */
    public function setWeaponId($v)
    {
        if ($v !== null) {
            $v = (int) $v;
        }
        ...
        if ($this->weapon_id !== $v) {
            $this->weapon_id = $v;
            $this->modifiedColumns[FragsTableMap::COL_WEAPON_ID] = true;
        }

        if ($this->aWeapons !== null && $this->aWeapons->getId() !== $v) {
            $this->aWeapons = null;
        }
    ...
    public function setCreated($v)
    {
        ...
        if ($this->created !== null || $dt !== null) {
            if ($this->created === null || $dt === null || $dt->format("Y-m-d H:i:s.u") !== $this->created->format("Y-m-d H:i:s.u")) {
                ...
                $this->modifiedColumns[FragsTableMap::COL_CREATED] = true;
            }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : FragsTableMap::translateFieldName('Id', TableMap::TYPE_PHPNAME, $indexType)];
            $this->id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : FragsTableMap::translateFieldName('FraggerId', TableMap::TYPE_PHPNAME, $indexType)];
            $this->fragger_id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : FragsTableMap::translateFieldName('FraggedId', TableMap::TYPE_PHPNAME, $indexType)];
    ...
    public function reload($deep = false, ConnectionInterface $con = null)
    {
        ...
        $dataFetcher = ChildFragsQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
    ...
    public function delete(ConnectionInterface $con = null)
    {
        ...
        $con->transaction(function () use ($con) {
            $deleteQuery = ChildFragsQuery::create()
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                FragsTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
    ...
    protected function doSave(ConnectionInterface $con)
    {
        ...
        if (!$this->alreadyInSave) {
            ...
            if ($this->aWeapons !== null) {
                if ($this->aWeapons->isModified() || $this->aWeapons->isNew()) {
                    $affectedRows += $this->aWeapons->save($con);
                }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(FragsTableMap::COL_ID)) {
            $modifiedColumns[':p' . $index++]  = 'id';
        }
        if ($this->isColumnModified(FragsTableMap::COL_FRAGGER_ID)) {
            $modifiedColumns[':p' . $index++]  = 'fragger_id';
        }
        if ($this->isColumnModified(FragsTableMap::COL_FRAGGED_ID)) {
    ...
    {
        $pos = FragsTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        if (isset($alreadyDumpedObjects['Frags'][$this->hashCode()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['Frags'][$this->hashCode()] = true;
        $keys = FragsTableMap::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getId(),
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\Frags The current object, for fluid interface
     */
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(FragsTableMap::COL_ID)) {
            $criteria->add(FragsTableMap::COL_ID, $this->id);
        }
        if ($this->isColumnModified(FragsTableMap::COL_FRAGGER_ID)) {
            $criteria->add(FragsTableMap::COL_FRAGGER_ID, $this->fragger_id);
        }
        if ($this->isColumnModified(FragsTableMap::COL_FRAGGED_ID)) {
            $criteria->add(FragsTableMap::COL_FRAGGED_ID, $this->fragged_id);
        }
        if ($this->isColumnModified(FragsTableMap::COL_WEAPON_ID)) {
    ...
    {
        $criteria = ChildFragsQuery::create();
        $criteria->add(FragsTableMap::COL_ID, $this->id);
     ...
     * objects.
     *
     * @param      object $copyObj An object of \Frags (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \Frags Clone of current object.
     * @throws PropelException
     */
    ...
    /**
     * Declares an association between this object and a ChildWeapons object.
     *
     * @param  ChildWeapons $v
     * @return $this|\Frags The current object (for fluent API support)
     * @throws PropelException
     */
    public function setWeapons(ChildWeapons $v = null)
    {
        if ($v === null) {
            $this->setWeaponId(NULL);
        } else {
            $this->setWeaponId($v->getId());
        }

        $this->aWeapons = $v;

        // Add binding for other direction of this n:n relationship.
        // If this object has already been added to the ChildWeapons object, it will not be re-added.
        if ($v !== null) {
            $v->addFragWeapon($this);
        }
    ...
    /**
     * Get the associated ChildWeapons object
     *
     * @param  ConnectionInterface $con Optional Connection object.
     * @return ChildWeapons The associated ChildWeapons object.
     * @throws PropelException
     */
    public function getWeapons(ConnectionInterface $con = null)
    {
        if ($this->aWeapons === null && ($this->weapon_id != 0)) {
            $this->aWeapons = ChildWeaponsQuery::create()->findPk($this->weapon_id, $con);
            /* The following can be used additionally to
                guarantee the related object contains a reference
                to this object.  This level of coupling may, however, be
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aWeapons->addFragWeapons($this);
             */
        }

        return $this->aWeapons;
    }
    ...
    {
        return (string) $this->exportTo(FragsTableMap::DEFAULT_STRING_FORMAT);
    }
