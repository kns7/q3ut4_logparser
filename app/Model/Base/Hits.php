...
/**
 * Base class that represents a row from the 'hits' table.
 *
 *
 *
 * @package    propel.generator..Base
 */
abstract class Hits implements ActiveRecordInterface
{
    /**
     * TableMap class name
     */
    const TABLE_MAP = '\\Map\\HitsTableMap';
    ...
    /**
     * Initializes internal state of Base\Hits object.
     */
    ...
    /**
     * Compares this with another <code>Hits</code> instance.  If
     * <code>obj</code> is an instance of <code>Hits</code>, delegates to
     * <code>equals(Hits)</code>.  Otherwise, returns <code>false</code>.
     *
     ...
     *
     * @return $this|Hits The current object, for fluid interface
     */
    ...
    /**
     * Get the [bodypart_id] column value.
     *
     * @return int
     */
    ...
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[HitsTableMap::COL_ID] = true;
        }
    ...
    public function setPlayerId($v)
    {
        ...
        if ($this->player_id !== $v) {
            $this->player_id = $v;
            $this->modifiedColumns[HitsTableMap::COL_PLAYER_ID] = true;
        }
    ...
    public function setBodypartId($v)
    {
        ...
        if ($this->bodypart_id !== $v) {
            $this->bodypart_id = $v;
            $this->modifiedColumns[HitsTableMap::COL_BODYPART_ID] = true;
        }

        if ($this->aBodyparts !== null && $this->aBodyparts->getId() !== $v) {
    ...
    public function setCounter($v)
    {
        ...
        if ($this->counter !== $v) {
            $this->counter = $v;
            $this->modifiedColumns[HitsTableMap::COL_COUNTER] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : HitsTableMap::translateFieldName('PlayerId', TableMap::TYPE_PHPNAME, $indexType)];
            $this->player_id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : HitsTableMap::translateFieldName('BodypartId', TableMap::TYPE_PHPNAME, $indexType)];
            $this->bodypart_id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 3 + $startcol : HitsTableMap::translateFieldName('Counter', TableMap::TYPE_PHPNAME, $indexType)];
    ...
    public function reload($deep = false, ConnectionInterface $con = null)
    {
        ...
        $dataFetcher = ChildHitsQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
    ...
    public function delete(ConnectionInterface $con = null)
    {
        ...
        $con->transaction(function () use ($con) {
            $deleteQuery = ChildHitsQuery::create()
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                HitsTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
    ...
    protected function doSave(ConnectionInterface $con)
    {
        ...
        if (!$this->alreadyInSave) {
            ...
            if ($this->aBodyparts !== null) {
                if ($this->aBodyparts->isModified() || $this->aBodyparts->isNew()) {
                    $affectedRows += $this->aBodyparts->save($con);
                }
                $this->setBodyparts($this->aBodyparts);
            }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(HitsTableMap::COL_PLAYER_ID)) {
        ...
        if ($this->isColumnModified(HitsTableMap::COL_COUNTER)) {
    ...
    {
        $pos = HitsTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        if (isset($alreadyDumpedObjects['Hits'][$this->hashCode()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['Hits'][$this->hashCode()] = true;
        $keys = HitsTableMap::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getId(),
            $keys[1] => $this->getPlayerId(),
            $keys[2] => $this->getBodypartId(),
        ...
        if ($includeForeignObjects) {
            ...
            if (null !== $this->aBodyparts) {
                ...
                $result[$key] = $this->aBodyparts->toArray($keyType, $includeLazyLoadColumns,  $alreadyDumpedObjects, true);
            }
        }
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(HitsTableMap::COL_PLAYER_ID)) {
            $criteria->add(HitsTableMap::COL_PLAYER_ID, $this->player_id);
        }
        if ($this->isColumnModified(HitsTableMap::COL_BODYPART_ID)) {
            $criteria->add(HitsTableMap::COL_BODYPART_ID, $this->bodypart_id);
        }
        if ($this->isColumnModified(HitsTableMap::COL_COUNTER)) {
            $criteria->add(HitsTableMap::COL_COUNTER, $this->counter);
        }
    ...
    {
        $criteria = ChildHitsQuery::create();
        $criteria->add(HitsTableMap::COL_ID, $this->id);
     ...
     * objects.
     *
     * @param      object $copyObj An object of \Hits (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \Hits Clone of current object.
     * @throws PropelException
     */
    ...
    /**
     * Declares an association between this object and a ChildBodyparts object.
     *
     * @param  ChildBodyparts $v
     * @return $this|\Hits The current object (for fluent API support)
     * @throws PropelException
     */
    public function setBodyparts(ChildBodyparts $v = null)
    {
        if ($v === null) {
        ...
        // Add binding for other direction of this n:n relationship.
        // If this object has already been added to the ChildBodyparts object, it will not be re-added.
        if ($v !== null) {
            $v->addHit($this);
        }
    ...
    /**
     * Get the associated ChildBodyparts object
     *
     * @param  ConnectionInterface $con Optional Connection object.
     * @return ChildBodyparts The associated ChildBodyparts object.
     * @throws PropelException
     */
    public function getBodyparts(ConnectionInterface $con = null)
    {
        if ($this->aBodyparts === null && ($this->bodypart_id != 0)) {
            $this->aBodyparts = ChildBodypartsQuery::create()->findPk($this->bodypart_id, $con);
            /* The following can be used additionally to
                guarantee the related object contains a reference
                to this object.  This level of coupling may, however, be
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aBodyparts->addHits($this);
             */
        }

        return $this->aBodyparts;
    }
    ...
    {
        return (string) $this->exportTo(HitsTableMap::DEFAULT_STRING_FORMAT);
    }
