...
/**
 * Base class that represents a row from the 'scores' table.
 *
 *
 *
 * @package    propel.generator..Base
 */
abstract class Scores implements ActiveRecordInterface
{
    /**
     * TableMap class name
     */
    const TABLE_MAP = '\\Map\\ScoresTableMap';
    ...
    /**
     * Initializes internal state of Base\Scores object.
     */
    ...
    /**
     * Compares this with another <code>Scores</code> instance.  If
     * <code>obj</code> is an instance of <code>Scores</code>, delegates to
     * <code>equals(Scores)</code>.  Otherwise, returns <code>false</code>.
     *
     ...
     *
     * @return $this|Scores The current object, for fluid interface
     */
    ...
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[ScoresTableMap::COL_ID] = true;
        }
    ...
    public function setPlayerId($v)
    {
        ...
        if ($this->player_id !== $v) {
            $this->player_id = $v;
            $this->modifiedColumns[ScoresTableMap::COL_PLAYER_ID] = true;
        }
    ...
    public function setScore($v)
    {
        ...
        if ($this->score !== $v) {
            $this->score = $v;
            $this->modifiedColumns[ScoresTableMap::COL_SCORE] = true;
        }
    ...
    public function setCreated($v)
    {
        ...
        if ($this->created !== null || $dt !== null) {
            if ($this->created === null || $dt === null || $dt->format("Y-m-d H:i:s.u") !== $this->created->format("Y-m-d H:i:s.u")) {
                ...
                $this->modifiedColumns[ScoresTableMap::COL_CREATED] = true;
            }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : ScoresTableMap::translateFieldName('Id', TableMap::TYPE_PHPNAME, $indexType)];
            $this->id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : ScoresTableMap::translateFieldName('PlayerId', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 3 + $startcol : ScoresTableMap::translateFieldName('Created', TableMap::TYPE_PHPNAME, $indexType)];
    ...
    public function reload($deep = false, ConnectionInterface $con = null)
    {
        ...
        $dataFetcher = ChildScoresQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
     ...
     * @return void
     * @throws PropelException
     * @see Scores::setDeleted()
     * @see Scores::isDeleted()
     */
    public function delete(ConnectionInterface $con = null)
    {
        ...
        $con->transaction(function () use ($con) {
            $deleteQuery = ChildScoresQuery::create()
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                ScoresTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(ScoresTableMap::COL_ID)) {
            $modifiedColumns[':p' . $index++]  = 'id';
        }
        if ($this->isColumnModified(ScoresTableMap::COL_PLAYER_ID)) {
            $modifiedColumns[':p' . $index++]  = 'player_id';
        }
        if ($this->isColumnModified(ScoresTableMap::COL_SCORE)) {
            $modifiedColumns[':p' . $index++]  = 'score';
        }
        if ($this->isColumnModified(ScoresTableMap::COL_CREATED)) {
    ...
    {
        $pos = ScoresTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        if (isset($alreadyDumpedObjects['Scores'][$this->hashCode()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['Scores'][$this->hashCode()] = true;
        $keys = ScoresTableMap::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getId(),
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(ScoresTableMap::COL_ID)) {
            $criteria->add(ScoresTableMap::COL_ID, $this->id);
        }
        if ($this->isColumnModified(ScoresTableMap::COL_PLAYER_ID)) {
            $criteria->add(ScoresTableMap::COL_PLAYER_ID, $this->player_id);
        }
        if ($this->isColumnModified(ScoresTableMap::COL_SCORE)) {
            $criteria->add(ScoresTableMap::COL_SCORE, $this->score);
        }
        if ($this->isColumnModified(ScoresTableMap::COL_CREATED)) {
            $criteria->add(ScoresTableMap::COL_CREATED, $this->created);
        }
    ...
    {
        $criteria = ChildScoresQuery::create();
        $criteria->add(ScoresTableMap::COL_ID, $this->id);
     ...
     * objects.
     *
     * @param      object $copyObj An object of \Scores (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \Scores Clone of current object.
     * @throws PropelException
     */
    ...
    {
        if (null !== $this->aPlayers) {
            $this->aPlayers->removeScore($this);
        }
        $this->id = null;
        $this->player_id = null;
        $this->score = null;
    ...
    {
        return (string) $this->exportTo(ScoresTableMap::DEFAULT_STRING_FORMAT);
    }
