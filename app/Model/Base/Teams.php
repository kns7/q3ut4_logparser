...
abstract class Teams implements ActiveRecordInterface
{
    ...
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[TeamsTableMap::COL_ID] = true;
        }
    ...
    public function setRoundId($v)
    {
        ...
        if ($this->round_id !== $v) {
            $this->round_id = $v;
            $this->modifiedColumns[TeamsTableMap::COL_ROUND_ID] = true;
        }
    ...
    public function setPlayerId($v)
    {
        ...
        if ($this->player_id !== $v) {
            $this->player_id = $v;
            $this->modifiedColumns[TeamsTableMap::COL_PLAYER_ID] = true;
        }
    ...
    public function setTeam($v)
    {
        ...
        if ($this->team !== $v) {
            $this->team = $v;
            $this->modifiedColumns[TeamsTableMap::COL_TEAM] = true;
        }
    ...
    public function setCreated($v)
    {
        ...
        if ($this->created !== null || $dt !== null) {
            if ($this->created === null || $dt === null || $dt->format("Y-m-d H:i:s.u") !== $this->created->format("Y-m-d H:i:s.u")) {
                ...
                $this->modifiedColumns[TeamsTableMap::COL_CREATED] = true;
            }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : TeamsTableMap::translateFieldName('Id', TableMap::TYPE_PHPNAME, $indexType)];
            $this->id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : TeamsTableMap::translateFieldName('RoundId', TableMap::TYPE_PHPNAME, $indexType)];
            $this->round_id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : TeamsTableMap::translateFieldName('PlayerId', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 4 + $startcol : TeamsTableMap::translateFieldName('Created', TableMap::TYPE_PHPNAME, $indexType)];
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(TeamsTableMap::COL_ID)) {
            $modifiedColumns[':p' . $index++]  = 'id';
        }
        if ($this->isColumnModified(TeamsTableMap::COL_ROUND_ID)) {
            $modifiedColumns[':p' . $index++]  = 'round_id';
        }
        if ($this->isColumnModified(TeamsTableMap::COL_PLAYER_ID)) {
            $modifiedColumns[':p' . $index++]  = 'player_id';
        }
        if ($this->isColumnModified(TeamsTableMap::COL_TEAM)) {
            $modifiedColumns[':p' . $index++]  = 'team';
        }
        if ($this->isColumnModified(TeamsTableMap::COL_CREATED)) {
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(TeamsTableMap::COL_ID)) {
            $criteria->add(TeamsTableMap::COL_ID, $this->id);
        }
        if ($this->isColumnModified(TeamsTableMap::COL_ROUND_ID)) {
            $criteria->add(TeamsTableMap::COL_ROUND_ID, $this->round_id);
        }
        if ($this->isColumnModified(TeamsTableMap::COL_PLAYER_ID)) {
            $criteria->add(TeamsTableMap::COL_PLAYER_ID, $this->player_id);
        }
        if ($this->isColumnModified(TeamsTableMap::COL_TEAM)) {
            $criteria->add(TeamsTableMap::COL_TEAM, $this->team);
        }
        if ($this->isColumnModified(TeamsTableMap::COL_CREATED)) {
            $criteria->add(TeamsTableMap::COL_CREATED, $this->created);
        }
    ...
    /**
     * Declares an association between this object and a ChildRounds object.
     *
     * @param  ChildRounds $v
     * @return $this|\Teams The current object (for fluent API support)
     * @throws PropelException
     */
    public function setRounds(ChildRounds $v = null)
    {
        if ($v === null) {
        ...
        // Add binding for other direction of this n:n relationship.
        // If this object has already been added to the ChildRounds object, it will not be re-added.
        if ($v !== null) {
            $v->addTeam($this);
        }
    ...
    /**
     * Get the associated ChildRounds object
     *
     * @param  ConnectionInterface $con Optional Connection object.
     * @return ChildRounds The associated ChildRounds object.
     * @throws PropelException
     */
    public function getRounds(ConnectionInterface $con = null)
    {
        if ($this->aRounds === null && ($this->round_id != 0)) {
            $this->aRounds = ChildRoundsQuery::create()->findPk($this->round_id, $con);
            /* The following can be used additionally to
                guarantee the related object contains a reference
                to this object.  This level of coupling may, however, be
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aRounds->addTeams($this);
             */
        }
    ...
    {
        if (null !== $this->aPlayers) {
            $this->aPlayers->removeTeam($this);
        }
        if (null !== $this->aRounds) {
            $this->aRounds->removeTeam($this);
        }
        $this->id = null;
        $this->round_id = null;
        $this->player_id = null;
